...
const client = new Client({
  phoneNumber: '201113981791', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "ℳℛ.𝒞", lid: "201508598557@lid", jid: "201508598557@s.whatsapp.net" },
  // Owner 2
    { name: "ℳℛ.𝒞", lid: "201508598557@lid", jid: "201508598557@s.whatsapp.net" },
  // Owner 3
    { name: "ℳℛ.𝒞", jid: "201508598557@s.whatsapp.net", lid: "201508598557@lid" },
  // Owner 4 
   { name: "ℳℛ.𝒞", jid: "201508598557@s.whatsapp.net", lid: "201508598557@lid" }
  ],
